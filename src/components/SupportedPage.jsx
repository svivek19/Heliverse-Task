...
const SupportedPage = () => {
  return (
    <div className="bg-[#19122A] w-11/12 mx-auto md:my-32 px-5 md:px-10 py-12 border border-slate-800 rounded-3xl">
      <h3 className="text-center text-slate-200 font-sora text-xl md:text-2xl font-semibold">
        Supported by All Popular Browsers
      </h3>
      <p className="text-center text-slate-300 md:w-1/3 my-4 mx-auto font-[200] font-sora text-lg">
